...
export default function AdminBookings() {
  ...
  const pendingCount = (bookings ?? []).filter(
    (b: Booking) => b.paymentStatus === PaymentStatus.pending,
  ).length;
                        ...
                        {booking.upiTxnId ? (
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <code className="font-mono text-xs bg-muted/40 px-2 py-0.5 rounded border border-border text-foreground cursor-default">
                                {booking.upiTxnId.slice(0, 12)}
                        ...
                        <div className="flex gap-1">
                          {booking.paymentStatus !==
                            ...
                            <Button
                              ...
                              className="bg-green-600/20 hover:bg-green-600/40 text-green-400 border-0 h-7 px-2 text-xs gap-1"
                          ...
                          {booking.paymentStatus !== PaymentStatus.rejected && (
                            <Button
                              ...
                              className="bg-destructive/10 hover:bg-destructive/20 text-destructive border-0 h-7 px-2 text-xs gap-1"
                              disabled={updateStatus.isPending}
